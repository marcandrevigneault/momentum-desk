...
|---|---|---|
| **1** | Feature library + univariate **decile-lift screener** + Feature Catalog | in progress |
| 2 | Exit-policy lab (same entries, swappable exits, compared) | planned |
| 3 | Evaluation gauntlet (purged CV, deflated Sharpe, regime, bootstrap CIs) | planned |
